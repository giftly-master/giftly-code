      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center">
            <Image src="/giftly-logo.svg" alt="Giftly" width={180} height={48} priority />
          </div>
      ...
      <section id="testimonials" className="py-24 bg-[#F8FAFF]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex overflow-x-auto gap-8 pb-8 no-scrollbar">
            {[
              { name: "Adewale Y.", role: "Early Adopter", text: "Giftly makes sending money feel like a real gift. The anticipation of the unlock date is what makes it special." },
              ...
              { name: "Eze K.", role: "Recipient", text: "Receiving a Giftly gift was such a fun experience. Scratching to see the message felt so personal." }
            ].map((t, i) => (
              <motion.div 
                key={i}
      ...
      <section id="faq" className="py-24 bg-white">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              { q: "How secure is Giftly?", a: "We use bank-grade encryption and the Stellar blockchain to ensure your funds are locked and secure until the release date." },
      ...
      <footer className="py-12 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:row justify-between items-center gap-6">
          <div className="flex items-center gap-2 opacity-50">
            <Image src="/giftly-logo.svg" alt="Giftly" width={140} height={36} />
          </div>
