    ...
    <div className="min-h-screen bg-white p-8 md:p-16 max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <p className="text-[#717182] text-lg leading-relaxed">
          Welcome to Giftly. By using our services, you agree to comply with the
        ...
        <div className="space-y-6 pt-4 text-[#18181B]">
          <section>
            ...
            <p className="text-[#717182]">
              By accessing or usingGiftly.online, you agree to be bound by these
          ...
          <section>
            ...
            <p className="text-[#717182]">
              ...
              Giftly, you represent and warrant that you meet this requirement.
            </p>
          </section>
        </div>
      </div>
