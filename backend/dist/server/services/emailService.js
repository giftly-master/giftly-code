...
exports.sendGiftConfirmationOTP = sendGiftConfirmationOTP;
exports.sendGiftCompletionToSender = sendGiftCompletionToSender;
exports.sendGiftNotificationToRecipient = sendGiftNotificationToRecipient;
...
async function sendForgotPasswordEmail(email, token, userName) {
...
async function sendSecurityAlertEmail(email, userName) {
    const mailOptions = {
        from: `"Zendvo Security" <${EMAIL_CONFIG.auth.user}>`,
        to: email,
...
function generateEmailTemplate(otp, userName) {
...
function generateForgotPasswordTemplate(resetLink, userName) {
    return generateBaseTemplate({
...
function generateSecurityAlertTemplate(userName) {
    return generateBaseTemplate({
...
function generateBaseTemplate({ title, userName, content, }) {
    return `
<!DOCTYPE html>
<html>
<head>
...
async function sendGiftConfirmationOTP(email, otp, userName) {
    const mailOptions = {
        from: `"Zendvo" <${EMAIL_CONFIG.auth.user}>`,
        to: email,
...
async function sendGiftCompletionToSender(senderEmail, senderName, shareLink, amount, currency, recipientName) {
...
async function sendGiftNotificationToRecipient(recipientEmail, recipientName, senderName, amount, currency, unlockDatetime) {
